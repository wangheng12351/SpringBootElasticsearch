...
<form role="form" style="width:350px;">
  <div class="form-group" align="center"  >
    ...
    <input type="text" class="form-control" id="channelid" placeholder="请输入通道id" required="required" ></label>
  ...
  <div class="container" align="left">
	<table class="table">
  <caption><font size="40">通道发送情况统计</font></caption>
  <thead>
    <tr>
